...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" border="0" class="tabaleContain">
        ...
        <tr>
            <td align="center">用 户 名：<asp:TextBox ID="txtUserName" runat="server"></asp:TextBox>
        ...
        <tr>
            <td align="center">教师姓名：<asp:TextBox ID="txtTeacherName" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtTeacherName"
                    ErrorMessage="请输入教师姓名！">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td align="center">
                <br />
