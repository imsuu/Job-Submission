...
<table width="100%" border="0" class="tabaleContain">
  <tr>
    <td align="center"><asp:DropDownList ID="DropDownList1" runat="server" Width="147px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
  ...
  <tr>
    <td align="center" style="height: 163px"><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%">
        <Columns>
  ...
  <tr>
    <td align="center"><asp:Button ID="btnOutExcel" runat="server" Text="导出到Excel表" Width="94px" OnClick="Button1_Click" />
