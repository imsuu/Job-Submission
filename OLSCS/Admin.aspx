...
<tr><td>
    ...
    <tr><td align="center">
        <br />
        <br />
        <asp:Button ID="btnAddTeacher" runat="server" Text="添加教师" OnClick="btnAddTeacher_Click" />
        <asp:Button ID="btnEditAdmin" runat="server" Text="修改管理员" Width="65px" OnClick="btnEditAdmin_Click" /></td></tr>
    </table>
</asp:Content>
